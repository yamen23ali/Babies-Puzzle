...
public class ExitDialog extends Activity implements OnClickListener {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		SharedPreferences prefs = getSharedPreferences("com.safey.BabiesPuzzle", getApplicationContext().MODE_PRIVATE);
	...
	public void onClick(View v) {
		...
		else
		{
			if (!rated)
			{
				...
				try {
					goToMarket
							.setData(Uri.parse("http://play.google.com/store/apps/details?id=com.safey.BabiesPuzzle"));
